...
class urgentMessage extends StatefulWidget {
  urgentMessage({Key? key}) : super(key: key);

  @override
  State<urgentMessage> createState() => _urgentMessageState();
}

class _urgentMessageState extends State<urgentMessage> {
  bool enable = true;
  @override
